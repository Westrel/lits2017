# coding: utf-8
# author: wx
# for definition of unet


import os
import sys
sys.path.append('\\'.join(os.path.split(sys.path[0])[:-1]))
# print(sys.path)
...
# 计算网络参数
print('ResUNet: total {} parameters.'.format(sum(param.numel() for param in net.parameters())))